...
**Data Analyst | Former Head Barista | Right-handed Southpaw Fighter**
...
I'm an IT student at **Australian Catholic University (ACU)** , passionate about turning messy data into clear, actionable insights.
...
I believe the best data projects come from real-world questions. That's exactly what I build.
...
| Category | Skills |
|:---|:---|
| **Programming** | Python (Pandas, NumPy, SciPy, Matplotlib, Seaborn), SQL |
| **Visualization** | Tableau Public, Power BI, Excel Pivot Tables |
